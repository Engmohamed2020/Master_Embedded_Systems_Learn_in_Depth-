...
#define UART_MODE_RX                        (uint32_t) (1<<2)  //RE =1 Bit 2 TE: Transmitter enabl P822
#define UART_MODE_TX                       	(uint32_t) (1<<3) //TE =1  Bit 3 TE: Transmitter enabl P822
...
//UART_Payload_Length_define Bit 12 M: Word length
...
#define UART_Parity__NONE                    (uint32_t)(0)       //P 821
#define UART_Parity__EVEN                    ((uint32_t)1<<10)
#define UART_Parity__ODD                     ((uint32_t)(1<<10 | 1<<9))

//@ref UART_StopBits_define  Bits 13:12 STOP: STOP bits  P823
...
//@ref UART_HwFlowCtl_define Bit 9 CTSE: CTS enable,Bit 8 RTSE: RTS enable
...
//@ref UART_IRQ_Enable_define P816
...
void MCAL_UART_GPIO_Set_Pins (USART_TypeDef *USARTx);
                                               ...
                                               //uint16_t BECAUSE DATA MAY BE 8 OR 9BITS
