...
typedef struct
{
	...
	GPIO_TypeDef* 	GPIOx;					// GPIO Port Used For EXTI Driver SELECTION

	uint16_t		GPIO_Pin;				// GPIO Pin Used For EXTI Driver SELECTION

	uint8_t			IVT_IRQ_Number;			// C	hoose Interrupt Handler From Interrupt Vector Table
}EXTI_GPIO_Mapping_t;
